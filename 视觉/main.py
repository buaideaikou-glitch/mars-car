...
thresholds = {
    "red": [
        [0, 80, 20, 95, -8, 58],       # 扩展范围
        [20, 60, 35, 80, 10, 40],      # 中心红色（实测）
        [0, 48, 28, 88, 2, 55]         # 暗部红色
    ],
    "blue": [
        [5, 90, -35, 25, -90, -5],     # 扩展范围
        [25, 70, -20, 15, -75, -25],   # 中心蓝色（实测）
        [10, 58, -28, 8, -82, -32]     # 暗部蓝色
    ],
    "yellow": [
        [30, 120, -45, 25, 38, 115],   # 扩展范围
        [50, 100, -30, 10, 60, 100],   # 中心黄色（实测）
        [38, 95, -22, 18, 48, 110]     # 亮/暗部黄色
    ],
    "purple": [
        [-25, 75, -5, 70, -78, 12],    # 扩展范围
        [-5, 55, 10, 50, -60, -10],    # 中心紫色（实测）
        [0, 42, 15, 55, -68, -18]      # 中间紫色
    ],
    "pink": [
        [20, 90, -5, 55, -22, 28],     # 扩展范围
        [40, 70, 10, 40, -5, 10],      # 中心粉色（实测）
        [28, 62, 3, 45, -12, 5]        # 暗部粉色
    ]
}
